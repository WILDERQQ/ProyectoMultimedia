...
$carreras = [
    'Informática','Sistemas Informáticos','Administración de Empresas',
    'Derecho','Medicina','Ingeniería Civil','Contaduría Pública','Comunicación Social',
    'Economía','Filosofía y Letras',
];
...
<div class="container py-4" style="max-width:760px;">
  ...
  <form method="POST" action="nueva_solicitud.php" id="form-nueva-solicitud">
    ...
    <div class="card mb-3">
      <div class="card-header fw-semibold"><i class="bi bi-file-text me-1"></i>Proyecto / Trabajo de Grado</div>
      <div class="card-body">
        <div class="row g-3">
          <div class="col-sm-8">
            <label for="titulo_proyecto" class="form-label small fw-medium">Título del Proyecto / Tesis</label>
          ...
          <div class="col-sm-4">
            <label for="tutor" class="form-label small fw-medium">Nombre del Tutor</label>
            <input type="text" class="form-control" id="tutor" name="tutor"
                   value="<?= limpiar($_POST['tutor']??'') ?>" placeholder="Ej: Dr. Juan Rodríguez">
          </div>
        </div>
      </div>
    </div>
